      ...
      {board.map((row, rowIndex) => (
        <div key={rowIndex} className="board-row">
          {row.map((cell, colIndex) => (
            ...
            >
              {cell.level > 0 && (
                <span className="cell-level">{cell.level}</span>
              )}
              {cell.professor && (
                <div
                  className={
                    cell.professor == "CLARO" || cell.professor == "REY"
                      ? "professor-token professor-token-blue"
                      : "professor-token professor-token-red"
                  }
                >
